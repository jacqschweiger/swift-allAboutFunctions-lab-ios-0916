 ...
 */
let secondFave = "Charlie Brown"

characterName(secondFave)

var thirdFave = "Woodstock"

characterName(thirdFave)
 ...
 */
func faveBand(band: String, number: Int) {
    print("My #\(number) favorite band is \(band).")
}

faveBand("the Beatles", number: 1)
...
madLib("Snoopy", noun:"dolphin", prep:"quickly")
...
func charName(name:String) -> String {
    print("To infinity and beyond, \(name.uppercaseString)!")
